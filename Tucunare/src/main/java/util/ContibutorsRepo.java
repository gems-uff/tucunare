...
public class ContibutorsRepo {
	public static void main(String[] args) throws UnknownHostException {
		ArrayList<String> list = Commits.getContributorsList("angular", "angular");
		Collections.sort(list);
		File file = new File("d:/Ruby200/lib/ruby/gems/2.0.0/gems/ghtorrent-0.10/","angularContributors.sh");
